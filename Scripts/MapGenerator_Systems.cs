...
public partial class MapGenerator : Node
{
    ...
    private void GenerateNewMapSave_Systems_Planets_Sol(DataBlock planetList)
    {
        {
    ...
    private void GenerateNewMapSave_Systems_Planets_Random(DataBlock planetList)
    {
        DataBlock star = Data.AddData(planetList, "Planet", "Star", DefLibrary);
        ...
        for (int n = 0; n < noOfPlanes; n++)
        {
            ...
            else
            {
                ...
                {
                    GenerateNewMapSave_Systems_Planets_Random_GasGiant(planetList, currentTemp, gasSystem == 2, out parentPlanetSize, out moons);

                }
                else if (n == noOfPlanes - gasPlanets && RNG.RandiRange(0, 99) < 80)
                {
                    GenerateNewMapSave_Systems_Planets_Random_AsteroidField(planetList, currentTemp);
                }
                else
                {
                    GenerateNewMapSave_Systems_Planets_Random_Planet(planetList, currentTemp, ref parentPlanetSize, ref moons);
                }
            }
        }
    }

    private void GenerateNewMapSave_Systems_Planets_Random_GasGiant(DataBlock planetList, int currentTemp, bool maxSize, out int parentPlanetSize, out int moons)
    {
    ...
    private void GenerateNewMapSave_Systems_Planets_Random_AsteroidField(DataBlock planetList, int currentTemp)
    {
        DataBlock planet = Data.AddData(planetList, "Planet", "Asteroid_Belt", DefLibrary);
    ...
    private void GenerateNewMapSave_Systems_Planets_Random_Planet(DataBlock planetList, int currentTemp, ref int parentPlanetSize, ref int moons)
    {
        ...
        Data.AddData(planet, "Temperature", currentTemp, DefLibrary);
        GenerateNewMapSave_Systems_Planets_Random_Planet_Atmomsphere(planet, type, size);
        GenerateNewMapSave_Systems_Planets_Random_Planet_Core(planet, type, size, currentTemp);
        GenerateNewMapSave_Systems_Planets_Random_Planet_WaterAndLife(planet, type, size, currentTemp);
    ...
    private void GenerateNewMapSave_Systems_Planets_Random_Planet_Atmomsphere(DataBlock planet, string planetType, int planetSize)
    {
        switch (planetType)
        {
            case "Lava":
            ...
            case "Vulcanic":
                {
                    ...
                    {
                        GenerateNewMapSave_Systems_Planets_Random_Planet_Atmomsphere_Options(planet, planetSize, "CO2", "N", "O2");
            ...
            case "Desert":
                {
                    GenerateNewMapSave_Systems_Planets_Random_Planet_Atmomsphere_Options(planet, planetSize, "N", "CO2", "O2");
            ...
            case "Temperate":
                {
                    GenerateNewMapSave_Systems_Planets_Random_Planet_Atmomsphere_Options(planet, planetSize, "N", "O2");
                    if (RNG.RandiRange(0, 99) < 10) Data.AddData(planet, "Toxic", DefLibrary);
                    break;
                }
            case "Ocean":
    ...
    private void GenerateNewMapSave_Systems_Planets_Random_Planet_Atmomsphere_Options(DataBlock planet, int planetSize, string firstOption, string secondOption = "", string thirdOption = "")
    {
    ...
    private void GenerateNewMapSave_Systems_Planets_Random_Planet_Core(DataBlock planet, string planetType, int planetSize, int temperature)
    {
        int iradiated = 2;
    ...
    private void GenerateNewMapSave_Systems_Planets_Random_Planet_WaterAndLife(DataBlock planet, string planetType, int planetSize, int temperature)
    {
