...
public partial class PlayerInput : Node
{
    ...
    public void CS_Action_from_Star_to_Select_Planet<T>(List<T> possibleActions) where T : ActionBase
    {
        ...
        Game.self.GalaxyUI.ShowStarInfo_ActionSelectPlanet(SelectedStar, possibleActions);
    ...
    {
        Game.self.GalaxyUI.ShowStarInfo_ShowMakeChoice(SelectedStar, possibleActions);
    ...
    {
        Game.self.GalaxyUI.ShowStarInfo_CancelMakeChoice();
    ...
    {
        Game.self.GalaxyUI.ShowStarInfo_CancelAction(SelectedStar);
